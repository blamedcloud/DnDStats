...
pub trait RVProb: Prob + PartialOrd<Self> + Ord + PartialEq<Self> + FromPrimitive + Reciprocal + for<'a> Sum<&'a Self> {}
impl<T: Integer + Clone> RVProb for Ratio<T> where Ratio<T>: FromPrimitive {}
