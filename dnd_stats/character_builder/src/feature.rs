...
mod tests {
    ...
    fn archery_test() {
        ...
        archer.level_up(vec!(Box::new(FightingStyle(FightingStyles::Archery))));
    ...
    fn defense_test() {
        ...
        fighter.level_up(vec!(Box::new(FightingStyle(FightingStyles::Defense))));
    ...
    fn dueling_test() {
        ...
        fighter.level_up(vec!(Box::new(FightingStyle(FightingStyles::Dueling))));
    ...
    fn gwf_test() {
        ...
        fighter.level_up(vec!(Box::new(FightingStyle(FightingStyles::GreatWeaponFighting))));
        let dmg: RandomVariable<BigRational> = fighter.get_basic_attack().unwrap().get_damage().get_base_dmg(&HashSet::new()).unwrap();
    ...
    fn twf_test() {
        ...
        fighter.level_up(vec!(Box::new(FightingStyle(FightingStyles::TwoWeaponFighting))));
